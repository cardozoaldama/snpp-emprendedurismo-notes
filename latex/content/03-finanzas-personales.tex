...
\begin{itemize}
\item Se confunden los ingresos del negocio con lo que va saliendo del bolsillo sin registro.
\item No sabés si realmente estás ganando o perdiendo.
\item Es difícil ahorrar, invertir o mejorar tu calidad de vida.
\end{itemize}
